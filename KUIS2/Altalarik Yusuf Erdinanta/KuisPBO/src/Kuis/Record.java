    ...
    private static void ambilData(){
        ...
        try{
            ...
            while (result.next()){
                ...
                objects[0] = result.getString("angka1");
                objects[1] = result.getString("angka2");
                objects[2] = result.getString("operator");
                objects[3] = result.getString("hasil");
