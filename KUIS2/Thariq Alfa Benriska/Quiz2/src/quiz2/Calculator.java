...
public class Calculator extends javax.swing.JFrame {
     ...
     */
    public Calculator(String nama, String phone) {
        Result = new InputData();
        initComponents();
        if(nama.equals(null)){
            jLabel5.setText("nama kosong");
        }else{
            jLabel5.setText("Hallo " +nama);
        }
        
        if(phone.equals(null)){
            jLabel6.setText("tlpn kosong");
        }else{
            jLabel6.setText("Telpn Anda = "+phone);
        }
    }
     double a, b, c;
    String operasi;
    ...
    private void initComponents() {
        ...
        operatorText = new javax.swing.JComboBox<String>();
...
//        hasiltext.setText(String.valueOf(hasil));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        new Table(inputText1.getText(), inputText2.getText(), (String) operatorText.getSelectedItem(), hasiltext.getText()).setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Calculator("Kosong", "000000").setVisible(true);
            }
        });
    }
